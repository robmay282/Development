...
'''
6. Write a for loop that loops through a string, counts all the characters (spaces included), and then prints how long the string is.
'''
...
'''
8. Adding conditionals to loops - Write some code that will loop through a string and print whether each letter is a vowel or a consonant.
'''
...
# List for reference
# my_vowel_list = ['a','e','i','o','u','y'] # our list collection

# my_vowel_tuple = ('a','e','i','o','u','y') # our tuple collection

# my_vowel_string = 'aeiouy' # our string
